...
export default function CategoryList ({categories=[] , handleSelectChildren,showCreateCategory}){
                ...
                {categories.map((cate,index) => (
                    <tr key={cate.id}
                        ...
                        <td className="p-3 text-center">
                            <MenuActions key={cate.id} category={cate} handleSelectChildren = {handleSelectChildren}  />
                        </td>
                    </tr>
                ))}
                </tbody>
