'use client'
import ProductList from "@/components/manager/product/product-list";
import ProductHeader from "@/components/manager/product/product-header";
...
export default function ProductController(data) {
    ...
    return (
        <div className='p-4'>
            <ProductHeader categories={categories} setSearch={setSearch} search={search} setCategoryFilter={setCategoryFilter} categoryFilter ={categoryFilter} />
