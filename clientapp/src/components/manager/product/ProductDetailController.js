...
import { ProductImagesManager } from "@/components/manager/product/ProductImageManager"
...
export default function ProductDetailController({ product, categories, brands }) {
    ...
    const validate = () => {
        ...
        if (!productUpdate.category || productUpdate.category === 0) newErrors.category = "Chọn danh mục"
        ...
        <div className="container mx-auto p-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="md:col-span-2">
                    <Card className="p-4">
                        <h2 className="text-lg font-bold border-b pb-2 mb-4">THÔNG TIN CHI TIẾT : {product.name}</h2>
                        ...
                        <div className="grid grid-cols-3 gap-4 mb-3">
                            ...
                            <div className="col-span-2">
                                ...
                                <Input type="text" name={"name"} value={productUpdate.name || ""} onChange={(e) => handleChange(e)} />
                        ...
                        <div className="grid grid-cols-3 gap-4 mb-3">
                            ...
                            <div className="col-span-2">
                                <span className="text-red-500">*</span>
                                <Input type="text" name="slug" value={productUpdate.slug} onChange={(e) => handleChange(e)} />
                    ...
                    <Card className="p-4">
                        <div className="flex justify-between border-b pb-2 mb-4">
                            ...
                            <div className="flex items-center">
                                ...
                                <Switch className="ml-2" checked={autoSeo} onCheckedChange={() => setAutoSeo(!autoSeo)} />
                            </div>
                        </div>
            ...
            <div className="p-4">
                <ProductImagesManager productId={product.id} initialImages={product.images} onImagesChange={null} />
            </div>
        </div>
    )
}
