...
export default function ProductListingPage({
    ...
    const [selectedCategory, setSelectedCategory] = useState<number | undefined>(initialFilters.categoryId)
    const [selectedBrands, setSelectedBrands] = useState(initialFilters.brandIds || [])
    const [sortOption, setSortOption] = useState<string>(initialFilters.sort || "default")
    ...
    const [tempSearchQuery, setTempSearchQuery] = useState<string>(initialFilters.search || "")
    ...
    }, [selectedCategory, selectedBrands, sortOption, currentPage, priceRange, searchQuery, pathname, router])
