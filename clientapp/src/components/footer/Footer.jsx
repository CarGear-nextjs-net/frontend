...
import { Clock, Heart, CheckCircle, Mail, Facebook, Twitter, Instagram, Linkedin } from "lucide-react"
            ...
            <footer className="bg-gray-900 text-gray-100">
                ...
                <div className="container mx-auto px-4 py-12">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-gray-400">
                                Chuyên cung cấp các sản phẩm ghế phụ cho trẻ em trên ô tô chất lượng cao, đảm bảo an toàn cho bé yêu của
                                bạn.
                            </p>
                            <div className="flex space-x-4">
                                <a href="#" className="bg-gray-800 p-2 rounded-full text-gray-400 hover:text-white transition-colors">
                    ...
                    <div className="border-t border-gray-800 mt-8 pt-6 text-center">
                        <p className="text-gray-400 text-sm">© {new Date().getFullYear()} CarGear. Tất cả quyền được bảo lưu.</p>
                    </div>
                </div>
            </footer>
        </>
