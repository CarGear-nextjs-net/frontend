...
export default function Sidebar({ user }) {
    ...
    return (
        <aside className={cn("bg-white border-r border-gray-200 flex flex-col h-full transition-all duration-300", collapsed ? "w-16" : "w-64")}>
            {/* Logo */}
            <div className={cn("h-16 flex items-center px-4 border-b border-gray-200", collapsed ? "justify-center" : "justify-between")}>
                {!collapsed && <Link href="/manager" className="font-bold text-xl">Admin</Link>}
