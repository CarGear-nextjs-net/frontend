...
export default function FloatingContactWidget() {
  ...
  const contactOptions = [
    ...
    },
    {
      id: "zalo",
      name: "Zalo",
      icon: <span className="font-bold text-sm leading-none">Zalo</span>,
      color: "#0068FF",
      link: "https://zalo.me/0963015160",
    },
    {
      id: "phone",
      name: "Call Us",
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 flex flex-col items-end gap-2">
      ...
      <button
        ...
        className={`w-12 min-h-12 h-fit flex flex-col items-center gap-2 justify-center rounded-full transition-transform duration-200 ${
          isCollapsed ? "bg-green-500 text-white" : "bg-auto text-green-500"
        }`}
      >
        {!isCollapsed &&
