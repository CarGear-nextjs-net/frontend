    ...
    <div className="container-fluid px-4 mx-auto">
      ...
      <div className="flex flex-col justify-center px-64">
        <div className="col-span-1 lg:col-span-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div>
              ...
              <div className="mb-4 md:mb-6 flex gap-4">
                <button
                  className="cursor-pointer px-6 py-3 bg-white text-black hover:bg-gray-100 border font-medium rounded-md flex items-center justify-center transition-colors"
                ...
                <button
                  className=" cursor-pointer px-6 py-3 bg-red-600 hover:bg-red-700 text-white font-medium rounded-md flex items-center justify-center transition-colors"
                  aria-label="Add to cart"
                  onClick={() => handleAddToCart()}
                >
          ...
          <div className="mb-8">
            <Tabs defaultValue="attributes" className="mt-6 flex-grow">
