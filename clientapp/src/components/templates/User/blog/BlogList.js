...
import { Calendar, Clock, User, Search, ChevronRight, Bookmark } from "lucide-react"
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="mb-12 text-center">
                <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Bài Viết Của Chúng Tôi</h1>
                ...
                <div className="mb-12">
                    ...
                    >
                        <div className="relative h-[400px] w-full">
                            <Image
                                src={featuredBlog.imageUrl || "/placeholder.svg?height=400&width=1200"}
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                                ...
                                <p className="text-gray-200 mb-4 line-clamp-2 md:line-clamp-3">{featuredBlog.excerpt}</p>
                                <Link href={`/bai-viet/${featuredBlog.slug}`}>
            ...
            {blogs.length > 0 ? (
                        ...
                        >
                            <Card className="h-full overflow-hidden border border-gray-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group">
                                <div className="relative h-48 w-full overflow-hidden">
                                    <Image
                                        src={blog.imageUrl || "/placeholder.svg?height=192&width=384"}
                                        alt={blog.title}
                                        fill
                                        className="object-cover transition-transform duration-500 group-hover:scale-105"
                                    />
                                    <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                    <Badge className="absolute top-3 left-3 bg-red-600 hover:bg-red-700">{blog.category}</Badge>
                ...
                <div className="text-center py-12 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-gray-500 mb-4">Không có bài viết nào phù hợp với tiêu chí tìm kiếm của bạn.</p>
                    <Button
                        onClick={() => {
                            setSearchTerm("")
