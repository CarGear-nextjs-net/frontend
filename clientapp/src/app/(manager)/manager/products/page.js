...
import ProductController from "@/components/manager/product/ProductController";
    ...
    try{
        ...
        return (
            <div className="w-full bg-white min-h-screen ">
                <ProductController products={products} categories={categories} brands={brands} totalPages = {totalPages}  />
            </div>
        )
    }catch(e){
