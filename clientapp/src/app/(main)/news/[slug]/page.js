import { ChevronLeft, ChevronRight, Eye, MessageSquare, ThumbsUp } from "lucide-react";
...
import RecommendedArticles from "@/components/templates/User/news/recommended-articles";
import RelatedArticles from "@/components/templates/User/news/related-articles";
  ...
  return [
    {
      ...
      excerpt:
        "Theo báo cáo mới nhất, Việt Nam đã vươn lên vị trí thứ 3 trong khu vực về thu hút đầu tư cho các startup công nghệ...",
    ...
    },
    {
      ...
      excerpt:
        "Nhiều tập đoàn công nghệ hàng đầu thế giới đang có kế hoạch mở rộng hoạt động và tăng cường đầu tư vào thị trường Việt Nam...",
    ...
    },
    {
      ...
      excerpt:
        "Chính phủ vừa ban hành nghị định mới với nhiều chính sách ưu đãi nhằm thúc đẩy sự phát triển của các doanh nghiệp công nghệ trong nước...",
  ...
  return [
    {
      ...
      excerpt:
        "Trí tuệ nhân tạo, metaverse và blockchain tiếp tục dẫn đầu danh sách các xu hướng công nghệ được quan tâm nhất trong năm 2023...",
    ...
    },
    {
      ...
      excerpt:
        "Với sự gia tăng của các vụ rò rỉ dữ liệu, việc bảo vệ thông tin cá nhân trở nên quan trọng hơn bao giờ hết...",
    ...
    },
    {
      ...
      excerpt:
        "Kỹ năng về AI, phân tích dữ liệu và phát triển cloud đang là những kỹ năng được các nhà tuyển dụng tìm kiếm nhiều nhất...",
