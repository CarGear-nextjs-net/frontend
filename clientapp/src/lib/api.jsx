...
export const fetchFilterProduct = async ({page,pageSize,categories,brands,minPrice,maxPrice,sortOrder}) => {
    const params = {
        page,
        pageSize,
...
export const createProduct  = async (data)=>{
    try{
        const response = await axios.post("/api/productmanager/create-product", data,{
            headers: {
